    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <form action="procesar_intervencion.php" method="post" class="row g-3">
                    ...
                    <?php
                        ...
                        try {
                            ...
                            $sql = "SELECT id, primer_nombre, primer_apellido FROM estudiantes";
                            $stmt = $conn->query($sql);
                        
                            // Verificar si la consulta devuelve resultados
                            if ($stmt->rowCount() > 0) {
                                // Mostrar cada estudiante como una opción en el menú desplegable
                                while ($row = $stmt->fetch()) {
                                    echo "<option value='" . htmlspecialchars($row['id']) . "'>" . htmlspecialchars($row['primer_nombre']) . " " . htmlspecialchars($row['primer_apellido']) . "</option>";
                                }
                            } else {
                    ...
                    <label for="fecha" class="form-label">Fecha de la Intervención:</label>
                    ...
                    <input type="text" id="tipo_intervencion" name="tipo_intervencion" class="form-control" required><br>


                    <label for="descripcion" class="form-label">Descripción de la Intervención:</label>
                    <textarea id="descripcion" name="descripcion" class="form-control" placeholder="Ingresse detalles de la intervención..." required></textarea><br>
                    <br>
                    <hr>
                   
                    <div class="col-12">
                                <br>
                                <button type="submit" class="btn btn-primary">Registrar Intervención</button>
