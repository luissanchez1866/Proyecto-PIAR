    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <h2>Registro Estudiante nuevo</h2>
                <hr>
                <br>
                <form action="procesar_registro_estudiante.php" method="post" class="row g-3">
                            ...
                            <legend>Información Educativa</legend>
                                ...
                                <div class="col-md-6">
                                    <label for="Nivel_Escolar" class="form-label">Nivel Escolar</label>
                                    <input type="text" id="Nivel_Escolar" name="Nivel_Escolar" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="Asignaturas" class="form-label">Asignaturas</label>
                                    <input type="text" id="Asignaturas" name="Asignaturas" class="form-control" required>
                                </div>
                                <div class="col-md-6">
                                    <label for="Necesidades_Especiales" class="form-label">Necesidades Especiales</label>
                                    <input type="text" id="Necesidades_Especiales" name="Necesidades_Especiales" class="form-control" required>
                                </div>
